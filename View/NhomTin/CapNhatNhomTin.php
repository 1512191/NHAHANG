        ...
        <div class="form-body">
            <form class="form-horizontal" method="POST" enctype="multipart/form-data">
                <div class="form-group has-info"><?php echo $tb; ?></div>
                            ...
                            <div class="col-xs-12 col-sm-5">
                                <span class="block input-icon input-icon-right">
                                    <input type="number" id="inputInfo" readonly="true" value="<?php echo $ctnt->MA;?>" class="width-100">
                           ...
                           <div class="form-group has-info">
                            ...
                            <div class="col-xs-12 col-sm-5">
                                <span class="block input-icon input-icon-right">
                                    <input type="text" id="inputInfo" name="ten"value="<?php echo $ctnt->TEN;?>" class="width-100">
                                    <i class="ace-icon fa fa-info-circle"></i>
                                </span>
                            </div>
                ...
                <div class="form-group has-info">
                            ...
                            <div class="col-xs-12 col-sm-5">
                                <span class="block input-icon input-icon-right">
                                    <input type="text" id="inputInfo" name="alias"value="<?php echo $ctnt->ALIAS;?>" class="width-100">
                                    <i class="ace-icon fa fa-info-circle"></i>
                                </span>
                            </div>
                ...
                <div class="form-group has-info">
                            ...
                            <label for="inputInfo" class="col-xs-12 col-sm-3 control-label no-padding-right">Trạng thái
                               ...
                               <div class="col-xs-12 col-sm-5" style="color: #337ab7">
                                   <div class="radio block"><label><input type="radio"name="tragthai" value="1" <?php if ($ctnt->TRANGTHAI == 1) echo'checked'; ?> >Đang hoạt động</label>
                                       <label><input type="radio" name="tragthai" value="0" <?php if ($ctnt->TRANGTHAI == 0) echo'checked'; ?> > Ẩn</label>
                                </div>
                            </div>
