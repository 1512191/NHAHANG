...
<div class="breadcrumbs ace-save-state" id="breadcrumbs">
    ...
    <div class="widget-box widget-color-blue ui-sortable-handle" id="widget-box-2" style="text-align: center">
                ...
                <table class="table table-striped table-bordered table-hover " style="text-align: center">
                    <thead class="thin-border-bottom">
                        <tr>
                            ...
                            <th class="hidden-480" style="text-align: center">Trạng thái</th> 
                            <th style="text-align: center">
                    ...
                    <tbody>
                        <?php
                        foreach ($dsnt as $item)
                        {
                            ?>
                        <tr>
                            <td class=""><?php echo $item->MA; ?></td>
                            <td class=""><?php echo $item->TEN;?></td>
                            <td class=""><?php echo $item->ALIAS;?></td>
                            <td class=""><?php echo date('d-m-Y',strtotime($item->NGAYCAPNHAT));?></td>
                             <td class=""><?php echo date('d-m-Y',strtotime($item->NGAYTAO));?></td>
                            

                            <td class="hidden-480">
                                <span class="<?php echo classtragThaiQT($item->TRANGTHAI)?>"><?php echo TrangThai($item->TRANGTHAI)?></span>
                            </td>
                            <td>
                                <a href="?controller=nhomtin&action=CapNhatNhomTin&ma=<?php echo $item->MA;?>" class="tooltip-success" data-rel="tooltip" title="Edit">
                                                        <span class="green">
                                                            <i class="ace-icon fa fa-pencil-square-o bigger-120"></i>
                                                        </span>
                                                    </a>
            
            <a onclick="return confirm('Bạn chắc chắn với điều này')" href="?controller=nhomtin&action=XoaNhomTin&ma=<?php echo $item->MA ?>" class="tooltip-error" data-rel="tooltip" title="Delete">
                                                        <span class="red">
