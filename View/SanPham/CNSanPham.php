    ...
    <div class="grid-1 ">
		...
		<i class="ace-icon fa fa-cloud-upload bigger-200"></i>
                ...
                <div class="form-group has-info">
                            ...
                            <div class="col-xs-12 col-sm-5">
                                <span class="block input-icon input-icon-right">
                                    <input type="number" id="inputInfo" name="gia" value="<?php echo $ctma->GIA;?>" class="width-100">
                                    <i class="ace-icon fa fa-info-circle"></i>
                                </span>
                            </div>
                          ...
                          <div class="form-group has-info">
                            ...
                            <div class="col-xs-12 col-sm-5">
                                <span class="block input-icon input-icon-right">
                                    <input type="text" id="inputInfo" name="ndtt" value="<?php echo $ctma->NOIDUNGTOMTAT;?>" class="width-100">
                                    <i class="ace-icon fa fa-info-circle"></i>
                                </span>
                            </div>
                  ...
                  <div class="form-group has-info">
                            ...
                            <div class="col-xs-12 col-sm-5">
                                <span class="block input-icon input-icon-right">
                                    <input type="number" id="inputInfo" name="giakm" value="<?php echo $ctma->GIA_KHUYEN_MAI;?>" class="width-100">
                                    <i class="ace-icon fa fa-info-circle"></i>
                                </span>
                            </div>
                 ...
                 <div class="form-group has-info">
                            ...
                            <div class="col-xs-12 col-sm-5">
                                <span class="block input-icon input-icon-right">
                                    <input type="text" id="inputInfo" name="kmai" value="<?php echo $ctma->KHUYENMAI;?>" class="width-100">
                                    <i class="ace-icon fa fa-info-circle"></i>
                                </span>
                            </div>
                 ...
                 <div class="form-group has-info">
                            ...
                            <div class="col-xs-12 col-sm-5">
                                <span class="block input-icon input-icon-right">
                                    <input type="text" id="inputInfo" name="tphan" value="<?php echo $ctma->THANHPHAN;?>" class="width-100">
                                    <i class="ace-icon fa fa-info-circle"></i>
                                </span>
                            </div>
                ...
                <div class="form-group has-info">
                 ...
                 <div class="form-group has-info">
                            ...
                            <div class="col-xs-12 col-sm-5">
                                <span class="block input-icon input-icon-right">
                                    <textarea rows="10" type="text" id="inputInfo" name="ndct" class="width-100"><?php echo $ctma->NOIDUNGCHITIET;?></textarea>
                                    <i class="ace-icon fa fa-info-circle"></i>
                                </span>
                            </div>
                ...
                <div class="form-group has-info">
                 ...
                 <div class="form-group has-info" >
                            ...
                            <button type="button" class="hinhchse btn btn-app btn-purple btn-sm" style="width: 120px; height: auto; font-size: 12px;">
		<i class="ace-icon fa fa-cloud-upload bigger-200"></i>
							Cập nhật hình không?
		</button>
                        </div>
                
                <div id="hinhchse" style="display: none">
       <div class="form-group has-info"> 
                 ...
                 <div class="form-group has-info">
                               ...
                               <button type="button" class="dshinh btn btn-app btn-purple btn-sm" style="width: 120px; height: auto; font-size: 12px;">
		<i class="ace-icon fa fa-cloud-upload bigger-200"></i>
							Cập nhật hình không?
		</button>
                            </div>
                <div id="dshinh" style="display: none">
                   <div class="form-group has-info"> 
...
<script>
    $(function(){
        ...
        $('.hinhchse').click(function(){
            $('#hinhchse').toggle();
        });
        $('.dshinh').click(function(){
            $('#dshinh').toggle();
        });
    })
</script>