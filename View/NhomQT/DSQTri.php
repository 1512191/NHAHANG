        ...
        <div class="widget-body">
            <div class="widget-main no-padding">
                <table class="table table-striped table-bordered table-hover " style="text-align: center">
                    ...
                    <tbody>
                        <?php
                        foreach ($dsqt as $item)
                        {
                            ?>
                        <tr>
                            <td class=""><?php echo $item->MA; ?></td>
                            <td class=""><?php echo $item->LOAIQTRI;?></td>
                            ...
                            <td>
                                <a href="?controller=quantri&action=CapNhatQT&ma=<?php echo $item->MA;?>" class="tooltip-success" data-rel="tooltip" title="Edit">
                                                        <span class="green">
                                                            <i class="ace-icon fa fa-pencil-square-o bigger-120"></i>
                                                        </span>
                                                    </a>
            
            <a onclick="return confirm('Bạn chắc chắn với điều này')" href="?controller=quantri&action=XoaQT&ma=<?php echo $item->MA ?>" class="tooltip-error" data-rel="tooltip" title="Delete">
                                                        <span class="red">
