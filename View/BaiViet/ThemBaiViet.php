                ...
                <div class="form-body">
                    <form class="form-horizontal"method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group has-info"> 
                            ...
                            <div class="col-xs-12 col-sm-5">
                                <input type="file" class="form-control" name="hinhchse">

                            </div>

                        </div>
                        <?php
                        if(isset($_POST['them'],$_FILES['hinhchse'] ) &&$_FILES['hinhchse']['error'] == 0)
                        {
                        ?>
                        <div class="form-group has-info" >
                            <label for="inputInfo" class="col-xs-12 col-sm-3 control-label no-padding-right">Hình</label>
                            <div class="col-xs-12 col-sm-5">
                                <img src="<?php echo 'Image/'.$_FILES['hinhchse']['name']; ?>" width="100px" height="auto">
                            </div>
                        </div>
                        <?php
                        }
                        ...
                        <div class="form-group has-info">
                            ...
                            <div class="col-sm-8">
                                <div class="radio block"><label><input type="radio" value="1"name="tragthai" <?php if (@$_POST['tragthai'] == 1) echo'checked'; ?> > Đang hoạt động</label>
                                    <label><input type="radio" value="0"name="tragthai" <?php if (@$_POST['tragthai'] == 0) echo'checked'; ?> > Ẩn</label>
                                </div>
                            </div>

                        </div>
                        <div class="form-group has-info">
                         <label for="inputInfo" class="col-xs-12 col-sm-3 control-label no-padding-right">Thuộc nhóm tin</label>
