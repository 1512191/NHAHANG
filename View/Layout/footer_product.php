				...
				<div class="col-md-3 agile-footer-grid">
					...
					<div class="popular-grids">
						<div class="popular-grid">
							<a href="single.html"><img src="<?php echo TEMPLATE_PRODUCT?>images/s1.jpg" alt="" /></a>
						</div>
						<div class="popular-grid">
							<a href="single.html"><img src="<?php echo TEMPLATE_PRODUCT?>images/s2.jpg" alt="" /></a>
						</div>
						<div class="popular-grid">
							<a href="single.html"><img src="<?php echo TEMPLATE_PRODUCT?>images/s3.jpg" alt="" /></a>
						</div>
						<div class="clearfix"> </div>
					</div>
					<div class="popular-grids">
						<div class="popular-grid">
							<a href="single.html"><img src="<?php echo TEMPLATE_PRODUCT?>images/s5.jpg" alt="" /></a>
						</div>
						<div class="popular-grid">
							<a href="single.html"><img src="<?php echo TEMPLATE_PRODUCT?>images/s6.jpg" alt="" /></a>
						</div>
						<div class="popular-grid">
							<a href="single.html"><img src="<?php echo TEMPLATE_PRODUCT?>images/s7.jpg" alt="" /></a>
						</div>
						<div class="clearfix"> </div>
					</div>
				</div>
