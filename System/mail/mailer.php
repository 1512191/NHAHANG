...
function guimail($nguoi_nhan,$tieu_de,$noi_dung, $bat_html=0)
{
	...
	$mailcfg['mailfrom'] = 'thanhhue97.qng@gmail.com';
	$mailcfg['fromname'] = 'Đặt món';
	$mailcfg['smtpauth'] = 1;
	$mailcfg['smtphost'] = 'smtp.gmail.com';
	$mailcfg['smtpuser'] = 'thanhhue97.qng@gmail.com'; //ten dang nhap gmail (server mail ben thu 3)
	$mailcfg['smtppass'] = 'wtpzbaoievcjejxu';//AETPTexeg9nC';//'HPAdxgDAnMAu'; //mat khau dang nhap email
	...
	$mail->AltBody = "Mail abc.com"; //Text Body
